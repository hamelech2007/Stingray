...
#include "Stingray/Platform/OpenGL/ImGuiOpenGLRenderer.h"
...
namespace Stingray {
	...
	void ImGuiLayer::OnAttach()
	{
        ...
        ImGui_ImplGlfw_KeyToImGuiKey(io);
	...
	void ImGuiLayer::OnEvent(Event& event)
	{
        ...
        dispatcher.Dispatch<MouseButtonPressedEvent>(SR_BIND_EVENT_FN(ImGuiLayer::OnMouseButtonPressedEvent));
        dispatcher.Dispatch<MouseButtonReleasedEvent>(SR_BIND_EVENT_FN(ImGuiLayer::OnMouseButtonReleasedEvent));
        dispatcher.Dispatch<MouseMovedEvent>(SR_BIND_EVENT_FN(ImGuiLayer::OnMouseMovedEvent));
        dispatcher.Dispatch<MouseScrolledEvent>(SR_BIND_EVENT_FN(ImGuiLayer::OnMouseScrolledEvent));
        dispatcher.Dispatch<KeyPressedEvent>(SR_BIND_EVENT_FN(ImGuiLayer::OnKeyPressedEvent));
        dispatcher.Dispatch<KeyReleasedEvent>(SR_BIND_EVENT_FN(ImGuiLayer::OnKeyReleasedEvent));
        dispatcher.Dispatch<KeyTypedEvent>(SR_BIND_EVENT_FN(ImGuiLayer::OnKeyTypedEvent));
        dispatcher.Dispatch<WindowResizeEvent>(SR_BIND_EVENT_FN(ImGuiLayer::OnWindowResizeEvent));
	}
